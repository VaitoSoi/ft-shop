...
| LOGGING_FILE      | 'default' or 'date'   | none          | 'default' use file, 'date' use date as file name, <other> dont use <br> Dont forget to add a `logs` folder so log files could be created |
